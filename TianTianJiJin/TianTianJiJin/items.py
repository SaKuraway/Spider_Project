...
class JijinDataItem(scrapy.Item):
    ...
    Assets_Scale = scrapy.Field()    # 资产管理规模
    Share_Scale = scrapy.Field()     # 份额规模
    Fund_Administrator = scrapy.Field()  # 基金管理人
    Fund_Custodian = scrapy.Field()      # 基金托管人
    Custodian_Rate = scrapy.Field()      # 托管费率
    ...
    # 12.基金经理变动表 Current_fund_manager_change：http://fund.eastmoney.com/f10/jjjl_{0}.html
    ...
    # 13.基金经理人历任基金表 All_fund_managers
