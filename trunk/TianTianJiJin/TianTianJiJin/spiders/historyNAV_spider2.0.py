...
# Fund_codes = ['000509']  # '001061','002393','539001','486002','000834','096001','000509'
...
for Fund_code in Fund_codes:
    try:
        ...
        Day_change = [i.xpath('.//text()')[0] if i.xpath('.//text()') else '' for i
                      in response.xpath("//table[@class='w782 comm lsjz']//tr/td[4]")] if response.xpath(
            "//table[@class='w782 comm lsjz']/tbody/tr/td[7]") else ['货币基金' for i in response.xpath(
            "//table[@class='w782 comm lsjz']//tr/td[1]")]  # 收益率
        Purchase_status = [i.xpath('.//text()')[0] if i.xpath('.//text()') else ''
                           for i in response.xpath("//table[@class='w782 comm lsjz']//tr/td[5]")] if response.xpath(
            "//table[@class='w782 comm lsjz']/tbody/tr/td[7]") else [
        ...
        Redeem_status = [i.xpath('.//text()')[0] if i.xpath('.//text()') else '' for i in
                         response.xpath("//table[@class='w782 comm lsjz']//tr/td[6]")] if response.xpath(
            "//table[@class='w782 comm lsjz']/tbody/tr/td[7]") else [
            i.xpath('.//text()')[0] if i.xpath('.//text()') else '' for i in
            response.xpath("//table[@class='w782 comm lsjz']//tr/td[5]")]  # 赎回状态
        Dividends_distribution = [i.xpath('.//text()')[0] if i.xpath('.//text()') else '' for i in
                                  response.xpath("//table[@class='w782 comm lsjz']/tbody/tr/td[7]")] if response.xpath(
            "//table[@class='w782 comm lsjz']/tbody/tr/td[7]") else [
            i.xpath('.//text()')[0] if i.xpath('.//text()') else '' for i in
        ...
        for History_NAV_Date, NAV, ANAV, Day_change, Purchase_status, Redeem_status, Dividends_distribution in zip(
            ...
            if History_NAV_Date not in existed_date:
                cur.execute(
                    ...
                    (Fund_code, History_NAV_Date, NAV, ANAV if response.xpath("//table[@class='w782 comm lsjz']/tbody/tr/td[7]") else None, None if response.xpath("//table[@class='w782 comm lsjz']/tbody/tr/td[7]") else ANAV, Day_change, Purchase_status, Redeem_status, Dividends_distribution))
                print('inserting data to mysql...', Fund_code, History_NAV_Date, NAV, ANAV if response.xpath("//table[@class='w782 comm lsjz']/tbody/tr/td[7]") else None, None if response.xpath("//table[@class='w782 comm lsjz']/tbody/tr/td[7]") else ANAV, Day_change, Purchase_status, Redeem_status, Dividends_distribution)
            # else:
            #     print('existed!skiping...')
