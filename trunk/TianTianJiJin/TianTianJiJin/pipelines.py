...
class TiantianjijinMysqlPipeline(object):
    ...
    def process_item(self, item, spider):
        ...
        try:
            ...
            if not cur.execute("select * from Fund_information where Fund_code=" + "'" + item['Fund_code'] + "'" + " and Spider_Date=" + "'" + item['Spider_Date'] + "'" + ";"):
                self.try_except(cur.execute("delete from Fund_information where Fund_code=" + "'" + item['Fund_code'] + "'" + " and Spider_Date=" + "'" + item['Spider_Date'] + "'" + ";"))
